<template>
  <div style="margin:0 auto;width: 100%;height: 100%; background-color: transparent;border:rgba(255,255,255,0);">
    <div class="pop" v-show="!(selectName === 'YXLQWYZTJG' || selectName === '')">
...
body {
   ...
   .pop {
  background: url('https://img.hzanchu.com/acimg/864fe2c3bfa0928f7bf4fc4577c66ead.png');
  background-size: 100%;
  width: 390px;
  // height: 96px;
